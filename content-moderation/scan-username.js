    ...
    if (res?.results?.length > 0) {
        ...
        if (result.flagged) {
            ...
            var embed = new EmbedBuilder()
                .setTitle("Joined/Updated User Flagged")
                .setColor("Blurple")
                .addFields([
                    { name: "Name displayed", value: member.displayName },
            ...
            var channel = member.guild.channels.cache.find(x => x.id == process.env.NOTIFCHANNEL);
